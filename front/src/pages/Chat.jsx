...
import { allUsersRoute, host, receiveGlobalMessageRoute, sendGlobalMessageRoute } from "../api/api";
...
function Chat() {
    ...
    const handleSendGlobalMessage = async (messageContent, messageId, createdAt, isAudio = false) => {
        if (messageContent.trim().length > 0 || isAudio) {
            ...
            setGlobalMessages((prevMessages) => [
                ...prevMessages,
                {
                    ...
                    message: isAudio ? { voice: messageContent.trim() } : { text: messageContent.trim() },
                    id: messageId,
                    createdAt,
            ...
            <div className="w-11/12 flex justify-between p-4 bg-cyan-900 border rounded-lg h-full shadow-md">
                <div className="flex flex-col w-3/12 h-full justify-between">
                    ...
                    <div className="p-2">
                        ...
                        <Contacts contacts={contacts} changeChat={handleChatChange} isGlobalChat={isGlobalChat} />
                    </div>
                </div>
